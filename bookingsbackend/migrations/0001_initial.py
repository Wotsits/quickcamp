# Generated by Django 3.1.7 on 2021-07-31 10:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ratetype', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookingsbackend.ratetype')),
            ],
        ),
        migrations.CreateModel(
            name='PitchType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', models.DateField()),
                ('end', models.DateField()),
                ('type', models.CharField(choices=[('Infant', 'Infant'), ('Child', 'Child'), ('Adult', 'Adult')], max_length=20)),
                ('checkedin', models.BooleanField(default=False)),
                ('noshow', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rateapplication', models.CharField(choices=[('per night', 'per night'), ('per booking', 'per booking')], max_length=20)),
        ...
        migrations.AddField(
            model_name='booking',
            name='bookingratetype',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookingsbackend.ratetype'),
        ),
        migrations.AddField(
            model_name='booking',
            name='guest',
