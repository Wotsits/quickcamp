    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('site', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='bookingsbackend.site')),
            ],
        ),
        migrations.CreateModel(
            name='PaymentChange',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(choices=[('Card', 'Card'), ('BACS', 'BACS'), ('Cash', 'Cash')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checkedin', models.BooleanField(default=False)),
                ('noshow', models.BooleanField(default=False)),
                ('booking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookingguests', to='bookingsbackend.booking')),
            ],
        ),
        migrations.CreateModel(
            name='Extra',
